...
| `/v2/classification/range` | POST | Alerta de faixa por período | `unidade_id`, `reference_period?`, `execution_id?` | `{outside_green_range, severity, classification, classification_label, reference_period, execution_id}` | 400, 401, 404, 422, 500 | `ClassificationHistoryService` | Processa o período informado, ou o dia anterior, e verifica faixas -2, 1, 2 |
